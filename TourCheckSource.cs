...
namespace MelbourneMentor
{
	...
	public class TourCheckSource : UITableViewSource
	{
		protected string[] tableItems;
		protected string cellIdentifier = "TableCell";
		UITableViewController owner;

		public TourCheckSource(string[] items, UITableViewController owner)
		{
			tableItems = items;
			this.owner = owner;
		}
		...
		{
			UIAlertController alertController = UIAlertController.Create("Selected Shpooing Centre", tableItems[indexPath.Row], UIAlertControllerStyle.Alert);
